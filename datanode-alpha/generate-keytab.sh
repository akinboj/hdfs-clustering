...
NAMENODE_PRINCIPAL="dn/${MY_POD_NAME}@${REALM}"
...
generate_keytab_if_not_exists "${NAMENODE_PRINCIPAL}" "${HDFS_KEYTAB_DIR}/dna.service.keytab"
...
chmod 600 ${HDFS_KEYTAB_DIR}/dna.service.keytab
chmod 600 ${HDFS_KEYTAB_DIR}/http.service.keytab

ls -lah ${HDFS_KEYTAB_DIR}
printf "%b" "read_kt ${HDFS_KEYTAB_DIR}/dna.service.keytab\nlist" | ktutil
