...
if [ "$MULTIHOMED_NETWORK" = "1" ]; then
    ...
    addProperty /etc/hadoop/hdfs-site.xml dfs.datanode.kerberos.principal dna/pegacorn-fhirplace-datanode-alpha-0.pegacorn-fhirplace-datanode-alpha.site-a.svc.cluster.local@${REALM}
