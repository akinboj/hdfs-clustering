...
echo "============================================================================================"
KRB5_TRACE=/dev/stderr kinit -f root/pegacorn-fhirplace-datanode-alpha-0.pegacorn-fhirplace-datanode-alpha.site-a.svc.cluster.local@${REALM} -kt ${KEYTAB_DIR}/merged-krb5.keytab -V &
wait -n
...
if [ "$MULTIHOMED_NETWORK" = "1" ]; then
    ...
    addProperty /etc/hadoop/hdfs-site.xml dfs.datanode.kerberos.principal root/pegacorn-fhirplace-datanode-alpha-0.pegacorn-fhirplace-datanode-alpha.site-a.svc.cluster.local@${REALM}
