...
NAMENODE_PRINCIPAL="nn/${MY_POD_NAME}@${REALM}"
...
generate_keytab_if_not_exists "${NAMENODE_PRINCIPAL}" "${HDFS_KEYTAB_DIR}/nn.service.keytab"
...
chmod 600 ${HDFS_KEYTAB_DIR}/nn.service.keytab
chmod 600 ${HDFS_KEYTAB_DIR}/http.service.keytab

ls -lah ${HDFS_KEYTAB_DIR}
printf "%b" "read_kt ${HDFS_KEYTAB_DIR}/nn.service.keytab\nlist" | ktutil
